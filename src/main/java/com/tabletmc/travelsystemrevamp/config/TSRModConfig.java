package com.tabletmc.travelsystemrevamp.config;
...
public class TSRModConfig implements ConfigData{
    ...
    public static void init() {
        AutoConfig.register(TSRModConfig.class, Toml4jConfigSerializer::new);
    }

    public static TSRModConfig getInstance() {
        return AutoConfig.getConfigHolder(TSRModConfig.class).getConfig();
    }
}
